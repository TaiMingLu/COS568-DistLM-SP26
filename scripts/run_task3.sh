...
srun python /n/fs/scratch/tl0463/Courses/COS568/COS568-DistLM-SP26/task3/run_glue.py \
    ...
    --num_train_epochs 1 \
    --output_dir /n/fs/scratch/tl0463/Courses/COS568/COS568-DistLM-SP26/output/task3/ --overwrite_output_dir \
