        ...
        for _ in train_iterator:
            ...
            for step, batch in enumerate(epoch_iterator):
                ...
                if (step + 1) % args.gradient_accumulation_steps == 0:
                    ...
                    # grad sync handled automatically by DistributedDataParallel
                    optimizer.step()
                    ##################################################
                ...
                prof.step()
                # Stop after 4 steps (1 wait + 3 active)
                if step >= 3:
...
def main():
    ...
    parser.add_argument("--master_ip", type=str, default="127.0.0.1",
                        help="The Master node IP address for distributed training")
    parser.add_argument("--master_port", type=str, default="12345",
                        help="Master node port for distributed training.")
    parser.add_argument("--world_size", type=int, default=1,
                        help="Num of nodes for distributed training")
    ...
    # warp model with DistributedDataParallel for auto gradient sync
    if args.local_rank != -1:
